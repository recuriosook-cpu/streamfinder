 ...
 * `{ next: { revalidate: 3600 } }`, proveedores de streaming incluidos. Lo único que cambia es que la página
    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-5xl mx-auto px-4 pb-10 relative z-10" style={{ marginTop: backdrop ? '-130px' : '24px' }}>
        ...
        <RatingsSection
          ...
          mediaType="movie"
        />
        <StreamingSection results={allProviders} mediaType="movie" mediaId={movie.id} />
        <ReviewsSection
          mediaId={movie.id}
          mediaType="movie"
          title={movie.title}
