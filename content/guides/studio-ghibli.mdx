...
<MovieGrid tmdbIds={[8392, 129]} label="El punto de partida" />
...
<MovieGrid tmdbIds={[81, 128, 4935]} label="La épica de Miyazaki" />
...
<MovieGrid tmdbIds={[16859, 10515, 11621, 149870]} label="Para completar la filmografía" />
